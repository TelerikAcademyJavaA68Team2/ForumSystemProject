...
public class FullProfileUserDto {
    ...
    public FullProfileUserDto(int id, String first_name, String last_name, String username, String email, String account_type, String account_status, String profile_photo) {
        this.id = id;
